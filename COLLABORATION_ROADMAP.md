...
**Honeymoon status:** In progress. A shared trip profile and shared reservations now support destination, dates, description, budget, confirmation, cost, paid amount, due date, create/edit/archive actions. Shared itinerary, packing, and travel documents remain to be migrated from their browser-local counterparts.
