...
**Idea boards status:** In progress. Shared board records now support create, edit, and archive for Owners, Editors, and Contributors. Shared board attachments and comments are the next migration steps; legacy browser-local boards remain visibly separate until then.
