...
- Preserve legacy wedding date/location values for display while an older workspace is blank; only an explicit Settings save may change shared wedding details.
